...
const columns: TableColumn<DataRow>[] = [
  {
    name: <div className='text-lg font-medium'>Invoice #</div>,
  ...
  {
    name: <div className='text-lg font-medium'>Quantity Motor (Vehicle)</div>,
    selector: (row: any) => row.endDate,
  },
  {
    name: <div className='text-lg font-medium'>Price Motor (Vehicle)</div>,
    selector: (row: any) => row.amount,
  },
  {
    name: <div className='text-lg font-medium'>Quantity Motor Cycle</div>,
    selector: (row: any) => row.amount,
  },
  {
    name: <div className='text-lg font-medium'>Price Motor Cycle</div>,
    selector: (row: any) => row.amount,
  },
  {
    name: <div className='text-lg font-medium'>Total</div>,
    selector: (row: any) => row.amount,
  },
  {
...
const Page = () => {
  ...
  return (
    <div className='w-full h-full'>
      <div className='mb-14'>
        <h2 className='text-2xl'>Sticker Purchase Reciepts</h2>
        <p className='text-sm text-gray-500'>List of all sticker purchases</p>
      </div>
      <Table
        columns={columns}
        tableData={data}
