    ...
    <ScrollSection className='bg-white shadow-md rounded p-4'>
      ...
      <div>
        ...
        >
          ...
          <InputField name='date' label='Quantity Motor (Vehicle)' />
          <InputField name='date' label='Total Motor (Vehicle)' />
          <InputField name='number' label='Unit Price Motor Cycle' />
          <InputField name='date' label='Quantity Motor Cycle' />
          <InputField name='date' label='Total Motor Cycle' />
          <InputField name='vecRegNumber' label='Total Purchase Value' />
