...
const columns: TableColumn<DataRow>[] = [
  {
    name: <div className="text-lg font-medium">Code</div>,
  ...
  {
    name: <div className="text-lg font-medium">Company</div>,
    selector: (row: any) => row.name,
  },
  ...
  return (
    <div className="w-full h-full">
      <div className="mb-14">
        ...
        <p className="text-sm text-gray-500">List of all Branches</p>
      </div>
      <Table
        Editor={() => {
          ...
          return (
            <div>
              <Form schema={schema} initialValues={{}} className="space-y-3">
                <InputField name="int#" label="Code" />
                <InputField name="phone" label="Branch Name" />
